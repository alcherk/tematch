...
export default function TokenChart({ data }: { data: CostEntry[] }) {
  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={chartData}>
        ...
        />
        <Bar dataKey="openai_tokens" name="OpenAI" fill="#00f0ff" stackId="tokens" radius={[1, 1, 0, 0]} />
        <Bar dataKey="claude_tokens" name="Claude" fill="#ff0080" stackId="tokens" radius={[1, 1, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
